        ...
        <section className="max-width shortener relative">
            ...
            <form className="form" onSubmit={handleSubmit}>
               <div className="flex flex-col md:flex-row">
                    <input type="url" placeholder="Shorten a link here" className="w-full py-2 px-5 rounded-lg mb-2 md:mb-0 md:w-2/3"
                    value={text}
                ...
                p-3 mt-3 rounded-lg shadow">
                    ...
                    <article>
                        <ul className="md:flex md:items-center">
                            ...
                            <li>
                                <button onClick={handleCopy} className="btn-cta rounded-lg focus:bg-slate-800">
                                    {buttonText}
                                </button>
                            </li>
                        </ul>
